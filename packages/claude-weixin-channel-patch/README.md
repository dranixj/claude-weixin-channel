# claude-weixin-channel-patch

一键启用 Claude Code Channels 功能。Fork 自 [cc-channel-patch](https://www.npmjs.com/package/cc-channel-patch)（MIT）。
...
```bash
# 修补（启用 Channels）
npx claude-weixin-channel-patch

# 恢复原始版本
npx claude-weixin-channel-patch unpatch
```
...
- `npx claude-weixin-channel-patch unpatch` 可随时恢复

## License

MIT — 保留了上游 cc-channel-patch 的版权声明。
